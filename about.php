...
<head>
    <?php $title = 'About - Vidya Sagar Preschool';
...
<body>
    ...
    <section class="legecy mt-2 mb-3 bg-light">
        <hr>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
    ...
    <section class="mt-2 mb-2 pt-4 pb-4 bg-light">
        <div class="container">
            <div class="row">
                <div class="col-md-3 py-md-1 py-4">
    ...
    <section class="miss-vis mt-2 mb-2 pt-4 pb-4">
        <div class="container">
            <div class="row flex-sm-column-reverse2 align-items-center py-md-4 py-2">
                <div class="col-md-6">
                ...
                <div class="col-md-5">
                    <div class="our-img">
                        <img src="./assets/img/vision.avif" class="image-fluid" alt="">
                    </div>
                </div>

            </div>

            <div class="row mt-3  align-items-center py-md-4 py-2">



                <div class="col-md-5">
                    <div class="our-img">
                        <img src="./assets/img/mission.avif" class="image-fluid" alt="">
                    </div>
                </div>
                <div class="col-md-1">
    ...
    <section class="our-culture mb-3 mt-3 pb-3 pt-3">

        <div class="container">
            <h2 class="culture-title text-center t-color-theme-red">
                Our Culture
            </h2>
            <p class="text-center">
